...
export default function PlanSection() {
    return (
        <section id="policy" className="PlanSection w-full flex flex-col bg-gray-100">
            ...
            <div className="w-full flex flex-col items-center lg:flex-row lg:flex-wrap lg:justify-center lg:gap-4">

                <div className="bg-white p-2 pl-3 border-l-6 border-blue-3 self-center max-w-md w-full mb-7 shadow-md lg:h-[220px]">
